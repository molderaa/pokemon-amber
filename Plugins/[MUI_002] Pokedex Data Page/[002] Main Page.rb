  ...
  def pbDataPageMenu
    ...
    loop do
      ...
      #-------------------------------------------------------------------------
        ...
        when :stats   then @cursor = :general
        when :family  then @cursor = :habitat
        when :habitat then @cursor = :general
        when :shape   then @cursor = :general
        when :egg     then @cursor = :general
        # when :item    then @cursor = :general
        end
        if @cursor != old_cursor
          pbPlayCursorSE
          pbDrawDataNotes
