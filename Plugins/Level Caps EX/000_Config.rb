module LevelCapsEX
  ...
  # Set this to true if the level cap should only affect the player's Pokémon.
  # Set this to false if the level cap should affect both the player's and the opponent's Pokémon.
  PLAYER_ONLY = true
end